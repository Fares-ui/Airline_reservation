        ...
        while True:
           ...
           if destination.isalpha():
            break
             ...
             print("Invalid Input")
        departure_time = self.get_valid_input("Enter Departure Time: ",int)
        ...
        for flight in self.__flights:
            if flight._Flight__flight_number == flight_number:
                while True:
                    ...
                    class_type = input("Enter Class Type (e.g., Economy, Business): ")
                    price = self.get_valid_input("Enter Price: ", float)
                    flight.add_seat(Seat(seat_number, class_type, price))
                    print("✅ Seat added.")
